...
//       // Filter vehicles with status 'in_use'
...
//         shipping_details: {}, // Reset shipping details when type changes
//       },
//     }))
//     setSelectedVehicle('') // Reset selected vehicle when shipping type changes
//   }
...
//         ...prev,
//         vehicle: {
//           name: vehicle.brand || '', // Assuming brand is the name
//           plate_no: vehicle.regisNumber || '', // Assuming regisNumber is the plate_no
//           driver_name: vehicle.assignedDriver?.driverName || '', // Get driver name from assignedDriver
//         },
//       }))
//     }
//   }
...
//           shipping_details: formData.shipping.shipping_details,
//         },
//         vehicle: formData.vehicle, // Include vehicle for all shipping types
//       }
...
//   // Vehicle selection component to avoid repetition
//   const VehicleSelect = () => (
//     <CFormSelect
//       className="mb-3"
...
//             {/* Vehicle selection is now available for all shipping types */}
